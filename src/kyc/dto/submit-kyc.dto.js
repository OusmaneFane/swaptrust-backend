...
var SubmitKycDto = function () {
    var _a;
    var _docType_decorators;
    var _docType_initializers = [];
    var _docType_extraInitializers = [];
    return _a = /** @class */ (function () {
            function SubmitKycDto() {
                this.docType = __runInitializers(this, _docType_initializers, void 0);
                __runInitializers(this, _docType_extraInitializers);
            }
            return SubmitKycDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _docType_decorators = [(0, swagger_1.ApiProperty)({ example: 'PASSPORT' }), (0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(2)];
