...
var FilterTransactionsDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function FilterTransactionsDto() {
                ...
                this.period = (__runInitializers(this, _direction_extraInitializers), __runInitializers(this, _period_initializers, void 0));
                __runInitializers(this, _period_extraInitializers);
            }
            return FilterTransactionsDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _status_decorators = [(0, swagger_1.ApiPropertyOptional)({ enum: client_1.TransactionStatus }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(client_1.TransactionStatus)];
            _direction_decorators = [(0, swagger_1.ApiPropertyOptional)({ description: 'sent | received' }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _period_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
