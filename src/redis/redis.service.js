...
var RedisService = function () {
    ...
    var RedisService = _classThis = /** @class */ (function () {
        function RedisService_1(config) {
            ...
            this.client = null;
            var host = this.config.get('redis.host');
            var port = this.config.get('redis.port');
            try {
                this.client = new ioredis_1.default({ host: host, port: port, maxRetriesPerRequest: 1, lazyConnect: true });
                void this.client.connect().catch(function () {
                    var _a;
                    _this.logger.warn('Redis unavailable — OTP cache disabled');
                    (_a = _this.client) === null || _a === void 0 ? void 0 : _a.disconnect();
                    _this.client = null;
                });
            }
            catch (_a) {
        ...
        RedisService_1.prototype.setex = function (key, seconds, value) {
            return __awaiter(this, void 0, void 0, function () {
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            _b.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.client.setex(key, seconds, value)];
                        case 2:
                            _b.sent();
                            return [3 /*break*/, 4];
                        case 3:
