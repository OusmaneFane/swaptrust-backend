...
var MatchingService = function () {
    ...
    var MatchingService = _classThis = /** @class */ (function () {
        ...
        MatchingService_1.prototype.band = function (low, high) {
            return { gte: low, lte: high };
        };
        /** Ordres opposés dont les montants croisés sont dans une fenêtre de ±10 %. */
        MatchingService_1.prototype.findMatches = function (orderId) {
            return __awaiter(this, void 0, void 0, function () {
                var order, opposite, tolFrom, tolTo, where;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.order.findUnique({ where: { id: orderId } })];
                        case 1:
                            order = _a.sent();
                            if (!order || order.status !== client_1.OrderStatus.ACTIVE)
                                return [2 /*return*/, []];
                            opposite = order.type === client_1.OrderType.SEND_CFA ? client_1.OrderType.SEND_RUB : client_1.OrderType.SEND_CFA;
                            tolFrom = (order.amountFrom * 10n) / 100n;
                            tolTo = (order.amountTo * 10n) / 100n;
                            where = {
                                id: { not: order.id },
                                userId: { not: order.userId },
                                status: client_1.OrderStatus.ACTIVE,
                                type: opposite,
