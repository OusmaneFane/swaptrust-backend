...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bcryptjs_1.default.hash('AdminSwapTrust123!', 12)];
                case 1:
                    password = _a.sent();
                    return [4 /*yield*/, prisma.user.upsert({
                            ...
                            create: {
                                ...
                                password: password,
                                countryResidence: client_1.CountryResidence.MALI,
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, bcryptjs_1.default.hash('UserDemo123!', 12)];
                case 3:
                    userPass = _a.sent();
                    return [4 /*yield*/, prisma.user.upsert({
                            ...
                            create: {
                                ...
                                countryResidence: client_1.CountryResidence.RUSSIA,
                                kycStatus: client_1.KycStatus.VERIFIED,
                            },
                            update: {},
                        })];
