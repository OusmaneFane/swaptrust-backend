...
var SmsService = function () {
    ...
    var SmsService = _classThis = /** @class */ (function () {
        function SmsService_1(config) {
            this.config = config;
            this.logger = new common_1.Logger(SmsService.name);
            this.client = null;
            var sid = this.config.get('twilio.accountSid');
            var token = this.config.get('twilio.authToken');
            if (sid && token) {
                this.client = (0, twilio_1.default)(sid, token);
            }
        }
        SmsService_1.prototype.sendOtp = function (phone, code) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/];
                        case 2:
                            this.logger.log("[DEV SMS] ".concat(phone, " \u2192 ").concat(body));
                            return [2 /*return*/];
                    }
                });
            });
